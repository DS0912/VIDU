...
public class AccountID {
	public static void main(String[] args) {
		try {
	        ...
	        //Compare text
	        By accountID = By.xpath("//div[@id='div-content-wrapper']/section/div/div[2]/div/div/table/tbody/tr[2]/td[2]");
	        WebElement AccountID = driver.findElement(accountID);
	        String id = AccountID.getText();
	        
	        try {
		        Assert.assertEquals(id, "ME679629");
